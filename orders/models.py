...
class Order(models.Model):
    ...
    menu_cost=DecimalField(verbose_name='Coste de menús (€)',blank=True,max_digits=10,decimal_places=2,default=0)
    worker_cost=DecimalField(verbose_name='Coste de trabajadores (€)',blank=True,max_digits=10,decimal_places=2,default=0)
    extra_cost=DecimalField(verbose_name='Coste de extras (€)',blank=True,max_digits=10,decimal_places=2,default=0)
    total_cost=DecimalField(verbose_name='Coste total (€)',blank=True,max_digits=10,decimal_places=2,default=0)
    income = DecimalField(verbose_name='Facturación sin IVA (€)',blank=True,max_digits=10,decimal_places=2,default=0)
    profit = DecimalField(verbose_name='Beneficio (€)',blank=True,max_digits=10,decimal_places=2,default=0)
    profit_rate = DecimalField(verbose_name='Rentabilidad (%)',blank=True,max_digits=10,decimal_places=2,default=0)
